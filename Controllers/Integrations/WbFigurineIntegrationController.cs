...
[ApiController]
[JwtAuthorize]
public class WbFigurineIntegrationController : IntegrationController<WbIntegration, FigurineReference, FigurineVariation>
{
    public WbFigurineIntegrationController(WbIntegration integration) : base(integration)
    {
    }

    [HttpPost]
    [Route("integrations/wildberries/figurines/update")]
    ...
    [HttpPost]
    [Route("integrations/wildberries/figurines/{id}/update")]
